      ...
      <div class="album py-5 bg-light">
          <div class="container">
            ...
            <b-row align-h="center" align-v="center">
              <b-col><a href="/posts/create/" class="btn btn-sm btn-outline-primary" role="button" aria-pressed="true">Create New Regex Pattern</a></b-col>
            </b-row>
            </b-container>
            <b-row>
                ...
                <div class="card mb-4 box-shadow">
                  ...
                  <div class="card-body">
                    <b-row align-h="between">
                      ...
                      <b-col cols="1">
                        <b-row class="mb-2">
                         <b-icon scale="2" icon="arrow-up-square"></b-icon>
                        </b-row>
                        <b-row class="mb-2">
                          <b-icon scale="2" icon="arrow-down-square"></b-icon>
                        </b-row>
                      </b-col>
                    </b-row>
