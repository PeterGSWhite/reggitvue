      ...
      <div class="container mw-0 px-3">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"><router-link :to = "{ name:'posts' }" exact>Posts</router-link></li>
            <li class="nav-item" v-if="accessToken==null"><router-link :to = "{ name:'login' }">Login</router-link></li>
            <li class="nav-item" v-if="accessToken==null"><router-link :to = "{ name:'register' }">Register</router-link></li>
